...
public final class Audio {
    ...
    @NonNull
    @Deprecated
    public static final String CODECSETTINGSFIRM = "Codec_Settings_Firm";
    ...
    @NonNull
    @Deprecated
    public static final String CODECSETTINGSLAW = "Codec_Settings_Law";
    ...
    /**
     * ID of layout of channels (e.g. MXF descriptor channel assignment). Warning, sometimes this is not enough for uniquely identifying a layout (e.g. MXF descriptor channel assignment is SMPTE
     * 377-4). For AC-3, the form is x,y with x=acmod and y=lfeon..
     */
    @NonNull
    ...
    @NonNull
    @Deprecated
    public static final String CODECSETTINGSENDIANNESS = "Codec_Settings_Endianness";
    ...
    @NonNull
    @Deprecated
    public static final String CODECSETTINGSITU = "Codec_Settings_ITU";
    ...
    @NonNull
    @Deprecated
    public static final String CODECSETTINGSSIGN = "Codec_Settings_Sign";
    ...
    @NonNull
    @Deprecated
    public static final String CODECSETTINGSFLOOR = "Codec_Settings_Floor";
