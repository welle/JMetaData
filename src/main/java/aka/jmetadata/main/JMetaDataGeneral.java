...
public final class JMetaDataGeneral extends AbstractJMetadata {
    ...
    /**
     * Get Location that the item was originaly designed/written. Information should be stored in the following format: country code, state/province, city where the coutry code is the same 2 octets as
     * in Internet domains, or possibly ISO-3166. e.g. US, Texas, Austin or US, , Austin..
     *
     * @return Location that the item was originaly designed/written. Information should be stored in the following format: country code, state/province, city where the coutry code is the same 2
     *         octets as in Internet domains, or possibly ISO-3166. e.g. US, Texas, Austin or US, , Austin..
     */
    @Nullable
